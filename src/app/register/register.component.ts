...
export class RegisterComponent implements OnInit {
  ...
  registerUser(index) {
    if (index == 1) {
      this.userService.registerUser(this.formRegisterWithEmail.value['names'], this.formRegisterWithEmail.value['lastnames'], this.formRegisterWithEmail.value['email'], this.formRegisterWithEmail.value['phone'], this.formRegisterWithEmail.value['id'], this.formRegisterWithEmail.value['pass']);
    } else {
      this.userService.registerUser(this.formRegisterWithEmail.value['namesSocial'], this.formRegisterWithEmail.value['lastnamesSocial'], this.formRegisterWithEmail.value['emailSocial'], this.formRegisterWithEmail.value['phoneSocial'], this.formRegisterWithEmail.value['idSocial'], '');
    }
